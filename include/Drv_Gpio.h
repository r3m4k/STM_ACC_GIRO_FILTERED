...
#define FlashReProgramError() for (;;){	MAIN_LED_ON();EXTRA_LED_ON();	for(int i=0;i<100000;i++);	MAIN_LED_OFF();EXTRA_LED_OFF();	for(int i=0;i<1000000;i++);	}// Светодиодная индикация ошибки перепрограммиования Flash
